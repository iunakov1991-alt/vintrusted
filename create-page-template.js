 ...
 * Generates SEO pages based on the standard template
 */
...
${content}
                ...
                <section class="cta-section">
                    ...
                    <div class="cta-buttons">
                        ...
                        <a href="${ctaSecondaryLink}" class="btn btn-secondary">${ctaSecondaryText}</a>
                    </div>
                </section>
            </article>
        </div>
...
module.exports = { generatePage, HEADER, FOOTER, STYLES };
