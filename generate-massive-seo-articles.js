...
function main() {
  ...
  for (const job of selected) {
    ...
    // Safely get hreflang.self with fallback
    const hreflangSelf = pageData.hreflang?.self || pageData.url || pageData.canonical || '/';
    const slugPath = slugFromUrl(hreflangSelf);
