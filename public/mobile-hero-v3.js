...
(function() {
  ...
  function initMobileHeroV3Form() {
    const form = document.getElementById('mobile-vin-form-v3');
    const input = document.getElementById('mobile-vin-input-v3');
    
    if (!form || !input) {
      console.log('[MOBILE-HERO-V3] Form not found');
      return;
    }
